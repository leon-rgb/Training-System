...
//	Horizon Occlusion – legacy reflections
	#if !UNITY_ENABLE_REFLECTION_BUFFERS
		#if LUX_HORIZON_OCCLUSION
			gi.indirect.specular *= GetHorizonOcclusion(s.eyeVec, s.normalWorld, worldNormalFace * facing, HORIZON_FADE);
		#endif
	#endif
...
//	Horizon Occlusion – deferred reflections
	#if UNITY_ENABLE_REFLECTION_BUFFERS
		#if LUX_HORIZON_OCCLUSION
			occlusion *= GetHorizonOcclusion(s.eyeVec, s.normalWorld, worldNormalFace * facing, HORIZON_FADE);
		#endif
	#endif
